...
At its core React is a solution to the problem that developers face when builiding user interface. It allows developers to build complex user interface without having to write a lot of tricky Javascript code. React JS intself is a library of sorts that is used to build user intefaces specifically. 

1. Describe component state.
The 'state' of the component is the object that determines how that component renders and behaves. The state is what allows use to create components that can be dynamic and interactive.

1. Describe props.
Props stand for properties in React. It is used to pass data from one component to another. 
