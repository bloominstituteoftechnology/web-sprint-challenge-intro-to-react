...
It helps create and update big applications easier than vanilla JS because it allows us to work with smaller pieces of a code - components. 
...
You sync effects in a React component to change of certain state or props by putting that state name inside the useEffect function. 
