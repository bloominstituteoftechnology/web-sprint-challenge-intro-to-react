...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web.
   -javascript front-end library sovles. dom manipulation it makes you create reausable compontents which can save time coding

1. Describe component state.
   compontent state deals with how you data is passed and how it is stored so you can later utilize it in your code
1. Describe props.
