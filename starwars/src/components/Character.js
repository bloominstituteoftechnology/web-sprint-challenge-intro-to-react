...
const Character = (props) => {
    ...
    return (
        <Container style={{backgroundColor: '#edd2a7',  display: 'flex', flexFlow: 'column wrap ', border: '2px solid #621b00', boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)', padding: '5%'}}>
            ...
            <CardTitle style={{textAlign: 'center', fontSize: '1.5rem', backgroundColor: '#8f7465', color: '#0d020a',  textShadow:'1px 1px 4px #ffffff', padding: '1%', boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)'}}>{props.name}</CardTitle>
